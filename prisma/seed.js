...
async function main() {
  ...
  const itemDefs = [
    // GPU
    { sku:"GPU-NV-4060TI-001",  name:"NVIDIA GeForce RTX 4060 Ti 8GB",            modelName:"RTX 4060 Ti",          cId:cGpu.id,bId:bNv.id,   sId:s1.id,wId:w1.id,qty:34,saf:15,price:489000,  status:"IN_STOCK",     specs:{메모리:"8GB GDDR6",   인터페이스:"PCIe 4.0 x16",TDP:"165W",포트:"HDMI 2.1 x1, DP 1.4a x3"} },
    { sku:"GPU-NV-4070S-001",   name:"NVIDIA GeForce RTX 4070 SUPER 12GB",         modelName:"RTX 4070 SUPER",       cId:cGpu.id,bId:bNv.id,   sId:s1.id,wId:w1.id,qty:8, saf:10,price:689000,  status:"LOW_STOCK",    specs:{메모리:"12GB GDDR6X", 인터페이스:"PCIe 4.0 x16",TDP:"220W",포트:"HDMI 2.1 x1, DP 1.4a x3"} },
    { sku:"GPU-NV-4080S-001",   name:"NVIDIA GeForce RTX 4080 SUPER 16GB",         modelName:"RTX 4080 SUPER",       cId:cGpu.id,bId:bNv.id,   sId:s2.id,wId:w1.id,qty:0, saf:8, price:1089000, status:"OUT_OF_STOCK", specs:{메모리:"16GB GDDR6X", 인터페이스:"PCIe 4.0 x16",TDP:"320W",포트:"HDMI 2.1 x1, DP 1.4a x3"} },
    { sku:"GPU-AMD-7600-001",   name:"AMD Radeon RX 7600 8GB",                     modelName:"RX 7600",              cId:cGpu.id,bId:bAmd.id,  sId:s1.id,wId:w1.id,qty:21,saf:12,price:319000,  status:"IN_STOCK",     specs:{메모리:"8GB GDDR6",   인터페이스:"PCIe 4.0 x8", TDP:"165W",포트:"HDMI 2.1 x1, DP 2.1 x3"} },
    { sku:"GPU-AMD-7800XT-001", name:"AMD Radeon RX 7800 XT 16GB",                 modelName:"RX 7800 XT",           cId:cGpu.id,bId:bAmd.id,  sId:s2.id,wId:w1.id,qty:5, saf:8, price:519000,  status:"LOW_STOCK",    specs:{메모리:"16GB GDDR6",  인터페이스:"PCIe 4.0 x16",TDP:"263W",포트:"HDMI 2.1 x1, DP 2.1 x2"} },
    // CPU
    { sku:"CPU-INT-13400F-001", name:"Intel Core i5-13400F",                       modelName:"Core i5-13400F",       cId:cCpu.id,bId:bIntel.id,sId:s1.id,wId:w1.id,qty:42,saf:20,price:179000,  status:"IN_STOCK",     specs:{코어:"10C/16T",클럭:"2.5GHz / 4.6GHz",소켓:"LGA1700",TDP:"65W"} },
    { sku:"CPU-INT-13700K-001", name:"Intel Core i7-13700K",                       modelName:"Core i7-13700K",       cId:cCpu.id,bId:bIntel.id,sId:s1.id,wId:w1.id,qty:18,saf:10,price:339000,  status:"IN_STOCK",     specs:{코어:"16C/24T",클럭:"3.4GHz / 5.4GHz",소켓:"LGA1700",TDP:"125W"} },
    { sku:"CPU-AMD-7600X-001",  name:"AMD Ryzen 5 7600X",                          modelName:"Ryzen 5 7600X",        cId:cCpu.id,bId:bAmd.id,  sId:s2.id,wId:w2.id,qty:3, saf:10,price:259000,  status:"LOW_STOCK",    specs:{코어:"6C/12T", 클럭:"4.7GHz / 5.3GHz",소켓:"AM5",   TDP:"105W"} },
    { sku:"CPU-AMD-7700X-001",  name:"AMD Ryzen 7 7700X",                          modelName:"Ryzen 7 7700X",        cId:cCpu.id,bId:bAmd.id,  sId:s2.id,wId:w2.id,qty:14,saf:8, price:329000,  status:"IN_STOCK",     specs:{코어:"8C/16T", 클럭:"4.5GHz / 5.4GHz",소켓:"AM5",   TDP:"105W"} },
    { sku:"CPU-AMD-9900X-001",  name:"AMD Ryzen 9 9900X",                          modelName:"Ryzen 9 9900X",        cId:cCpu.id,bId:bAmd.id,  sId:s4.id,wId:w2.id,qty:9, saf:6, price:529000,  status:"IN_STOCK",     specs:{코어:"12C/24T",클럭:"4.4GHz / 5.6GHz",소켓:"AM5",   TDP:"120W"} },
    // RAM
    { sku:"RAM-SAM-DDR5-32-001",  name:"Samsung DDR5 32GB Kit",                   modelName:"M323R2GA3BB0",         cId:cRam.id,bId:bSam.id,  sId:s5.id,wId:w2.id,qty:35,saf:15,price:129000,  status:"IN_STOCK",     specs:{용량:"16GB×2",속도:"DDR5-4800",레이턴시:"CL40",전압:"1.1V"} },
    { sku:"RAM-GSK-TZ5-32-001",   name:"G.Skill Trident Z5 DDR5 32GB Kit",        modelName:"F5-6400J3239G16GX2",  cId:cRam.id,bId:bGsk.id,  sId:s3.id,wId:w2.id,qty:11,saf:8, price:159000,  status:"IN_STOCK",     specs:{용량:"16GB×2",속도:"DDR5-6400",레이턴시:"CL32",전압:"1.4V"} },
    { sku:"RAM-COR-DDR5-64-001",  name:"Corsair Vengeance DDR5 64GB Kit",         modelName:"CMK64GX5M2B5200C40",  cId:cRam.id,bId:bCor.id,  sId:s3.id,wId:w2.id,qty:7, saf:8, price:219000,  status:"LOW_STOCK",    specs:{용량:"32GB×2",속도:"DDR5-5200",레이턴시:"CL40",전압:"1.25V"} },
    { sku:"RAM-SKH-DDR5-32-001",  name:"SK hynix Platinum HX DDR5 32GB Kit",     modelName:"HMCG78AEBSA095N",     cId:cRam.id,bId:bSkh.id,  sId:s5.id,wId:w2.id,qty:20,saf:10,price:139000,  status:"IN_STOCK",     specs:{용량:"16GB×2",속도:"DDR5-5600",레이턴시:"CL36",전압:"1.25V"} },
    // SSD
    { sku:"SSD-SAM-990P-1T-001",  name:"Samsung 990 Pro NVMe SSD 1TB",           modelName:"MZ-V9P1T0BW",         cId:cSsd.id,bId:bSam.id,  sId:s5.id,wId:w1.id,qty:48,saf:20,price:149000,  status:"IN_STOCK",     specs:{용량:"1TB",인터페이스:"NVMe M.2",읽기:"7450MB/s",쓰기:"6900MB/s"} },
    { sku:"SSD-SKH-P41-1T-001",   name:"SK hynix Platinum P41 NVMe 1TB",         modelName:"SHPP41-1000GM-2",     cId:cSsd.id,bId:bSkh.id,  sId:s4.id,wId:w1.id,qty:31,saf:15,price:139000,  status:"IN_STOCK",     specs:{용량:"1TB",인터페이스:"NVMe M.2",읽기:"7000MB/s",쓰기:"6500MB/s"} },
    { sku:"SSD-SAM-870EVO-2T-001",name:"Samsung 870 EVO SATA SSD 2TB",           modelName:"MZ-77E2T0B/KR",       cId:cSsd.id,bId:bSam.id,  sId:s5.id,wId:w1.id,qty:0, saf:15,price:169000,  status:"OUT_OF_STOCK", specs:{용량:"2TB",인터페이스:"SATA 6Gb/s",읽기:"560MB/s",쓰기:"530MB/s"} },
    { sku:"SSD-SAM-990-2T-001",   name:"Samsung 990 EVO NVMe SSD 2TB",           modelName:"MZ-V9E2T0BW",         cId:cSsd.id,bId:bSam.id,  sId:s5.id,wId:w1.id,qty:22,saf:10,price:219000,  status:"IN_STOCK",     specs:{용량:"2TB",인터페이스:"NVMe M.2",읽기:"5000MB/s",쓰기:"4200MB/s"} },
    // Mainboard
    { sku:"MB-ASUS-B650E-001",    name:"ASUS ROG STRIX B650E-F Gaming WiFi",     modelName:"ROG STRIX B650E-F",   cId:cMb.id, bId:bAsus.id, sId:s1.id,wId:w2.id,qty:11,saf:6, price:389000,  status:"IN_STOCK",     specs:{소켓:"AM5",    칩셋:"AMD B650E",   폼팩터:"ATX",메모리슬롯:"DDR5 ×4"} },
    { sku:"MB-MSI-Z790-001",      name:"MSI PRO Z790-A WiFi DDR5",               modelName:"PRO Z790-A WiFi",     cId:cMb.id, bId:bMsi.id,  sId:s1.id,wId:w2.id,qty:4, saf:8, price:329000,  status:"LOW_STOCK",    specs:{소켓:"LGA1700",칩셋:"Intel Z790", 폼팩터:"ATX",메모리슬롯:"DDR5 ×4"} },
    // PSU
    { sku:"PSU-SEA-850G-001",     name:"Seasonic FOCUS GX-850 골드",              modelName:"FOCUS-GX-850",        cId:cPsu.id,bId:bSeas.id, sId:s2.id,wId:w3.id,qty:16,saf:8, price:179000,  status:"IN_STOCK",     specs:{출력:"850W", 등급:"80+ Gold",    모듈방식:"완전모듈",팬크기:"120mm"} },
    { sku:"PSU-BEQ-1000P-001",    name:"be quiet! Dark Power 13 1000W 플래티넘",  modelName:"BN332",               cId:cPsu.id,bId:bBeq.id,  sId:s2.id,wId:w3.id,qty:6, saf:5, price:289000,  status:"IN_STOCK",     specs:{출력:"1000W",등급:"80+ Platinum",모듈방식:"완전모듈",팬크기:"135mm"} },
    // Case
    { sku:"CASE-FRD-NR400-001",   name:"Fractal Design North Charcoal Black",    modelName:"FD-C-NOR1C-02",       cId:cCase.id,bId:bFrd.id, sId:s3.id,wId:w3.id,qty:9, saf:5, price:159000,  status:"IN_STOCK",     specs:{폼팩터:"ATX Mid Tower",재질:"메쉬+우드",드라이브베이:'2×3.5", 2×2.5"',쿨링:"최대 9개 팬"} },
    // Cooler
    { sku:"COOL-NOC-NHD15-001",   name:"Noctua NH-D15 크롬맥스 CPU 쿨러",         modelName:"NH-D15 chromax.black",cId:cCool.id,bId:bNoc.id, sId:s4.id,wId:w3.id,qty:12,saf:5, price:129000,  status:"IN_STOCK",     specs:{높이:"165mm",팬:"NF-A15 ×2",소켓지원:"LGA1700, AM5, AM4",TDP:"250W+"} },
    // HDD
    { sku:"HDD-SEA-4T-001",       name:"Seagate BarraCuda 4TB HDD",              modelName:"ST4000DM004",         cId:cHdd.id,bId:bSea.id,  sId:s5.id,wId:w2.id,qty:8, saf:6, price:99000,   status:"IN_STOCK",     specs:{용량:"4TB",속도:"5400RPM",인터페이스:"SATA 6Gb/s",캐시:"256MB"} },
    { sku:"HDD-SEA-2T-001",       name:"Seagate BarraCuda 2TB HDD",              modelName:"ST2000DM008",         cId:cHdd.id,bId:bSea.id,  sId:s5.id,wId:w2.id,qty:9, saf:6, price:69000,   status:"IN_STOCK",     specs:{용량:"2TB",속도:"7200RPM",인터페이스:"SATA 6Gb/s",캐시:"256MB"} },
  ];
