...
import { PushTestCard } from "@/components/settings/PushTestCard";
...
export default async function SettingsPage() {
  ...
  return (
    <div className="flex flex-col">
      <PageHeader
        title="설정"
        subtitle="시스템 운영 및 사용자 환경을 관리합니다"
      />
      ...
      <div className="max-w-2xl space-y-5 p-6">
        <SectionCard title="일반 설정">
          <div className="space-y-4">
            <div>
              <label className="mb-1.5 block text-[12px] font-semibold text-foreground">시스템 이름</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-1.5 block text-[12px] font-semibold text-foreground">기본 통화</label>
              <input
                type="text"
                defaultValue="KRW (원)"
                readOnly
            ...
            <div>
              <label className="mb-1.5 block text-[12px] font-semibold text-foreground">타임존</label>
              <input
                type="text"
        ...
        <SectionCard title="사용자 관리" subtitle="계정 및 역할을 관리합니다 (ADMIN 전용)">
          <Link
            ...
            className="flex items-center gap-3 rounded-md border border-border px-4 py-3 transition-colors hover:bg-muted/40"
          >
            ...
            <div className="flex-1">
              ...
              <p className="mt-0.5 text-[11px] text-muted-foreground">계정 생성, 수정, 삭제 및 ADMIN/OPERATOR/VIEWER 권한 부여</p>
            </div>
